...
public class Skeleton extends Doll {
    public Skeleton(String name, int hp, int capacity, Decal sprite, int movementsPoints, int level, int experience, int strength, int dexterity, int constitution, int initiativebonus, Classification classification) {
    ...
    public Skeleton(){
        ...
        super("Skeleton", 4,0, Decal.newDecal(1,1, NewTexturePack.skeleton, true),
                7, 1, 0,
                12,8,10,
