...
public class Spider extends Doll {
    public Spider(String name, int hp, int capacity, Decal sprite, int movementsPoints, int level, int experience, int strength, int dexterity, int constitution, int initiativebonus, Classification classification) {
    ...
    public Spider (){
        ...
        super("Spider", 10, 0, Decal.newDecal(1,1, NewTexturePack.spider, true), 10, 1,
                0, 16, 14,14,
