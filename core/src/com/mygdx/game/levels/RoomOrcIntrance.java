 ...
 */
public class RoomOrcIntrance extends Room {
    Map map;

    public RoomOrcIntrance(TerrainPack terrainPack, TexturePack texturePack, GameObjectPack gameObjectPack) {
        super(6,7, new Map(6,7, null));
        ...
        map.addTile(terrainPack.getFloor_mid(),2,0);
        ...
        map.addTile(terrainPack.getFloor_mid(),1,1);
        ...
        map.addTile(terrainPack.getLava(),     0,5);
        ...
        map.addTile(terrainPack.getLava(),     0,6);
        map.addTile(terrainPack.getFloor_min(),1,6);
        map.addTile(terrainPack.getFloor_min(),2,6);
        map.addTile(terrainPack.getLava(),     3,6);
        map.addTile(terrainPack.getLava(),     4,6);
        map.addTile(terrainPack.getLava(),     5,6);
